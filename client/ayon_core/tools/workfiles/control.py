...
class BaseWorkfileController(
    ...
    def get_assigned_folder_paths(self, project_name, sender=None, assignee=None):
        return self._hierarchy_model.get_assigned_folder_paths(project_name, sender, assignee)
