...
WORKFILE_BUILD_PLUGIN_PATH = os.path.join(PLUGINS_DIR, "workfile_build")
...
class MayaHost(HostBase, IWorkfileHost, ILoadHost, IPublishHost):
    ...
    def install(self):
        ...
        register_template_placeholder_plugin_path(WORKFILE_BUILD_PLUGIN_PATH)
...
def uninstall():
    ...
    deregister_template_placeholder_plugin_path(WORKFILE_BUILD_PLUGIN_PATH)
